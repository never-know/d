...
Drag.prototype = {
  ...
  initialize: function(drag, options) {
	...
	$(this._Handle).bind('touchstart', BindAsEventListener(this, this.Start));
  },
  //设置默认属性
  ...
  Start: function(oEvent) {
	...
	$(document).bind('touchmove', this._fM);
  ...
  console.log('stop');
	...
	$(document).unbind('touchmove',this._fM);
	$(document).unbind('touchend',this._fS);
	if(isIE){
