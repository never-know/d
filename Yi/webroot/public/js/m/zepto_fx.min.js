...
function page_load(url,template) {
var loading= false,current_page=1,total_page=2;
$('.weui_tab_bd').infinite(250).on("infinite", function() {
		...
		$.ajax({
			url:url, 
			type:'GET', 
			data: (($('#list_form').length>0)?$('#list_form').serialize():{page:current_page+1}),
