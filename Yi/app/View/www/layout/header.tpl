...
<div class="header">          
	<div class="header-inner">   
			...
			<div class="summary hide" style="float: left;margin: 6px 20px 10px 130px;font-size: 16px;">
				<span>帐户余额</span> <strong style="color: #e8585a;font-size: 26px; margin-left: 8px;">￥200</strong>
			</div> 
			
			
			
			<div class="account">                       	    
				<a href="" class="avatar"><img src="/public/images/avater.png" /></a>                          
				<a href="" class="nickname">ybcoming</a>  
