        ...
        <a href="/user/profile.html" class="weui_media_box weui_media_appmsg" style="padding:30px 15px;margin-left:.5em">
          ...
          <div class="weui_media_bd" style="margin-left:.8em;margin-top:4px;color:white;letter-spacing: 1px;">
		   ...
		   <div class="weui_media_hd" id="qrcode" style="text-align: right;margin-right: 0;">
            <img class="weui_media_appmsg_thumb" src="/public/images/abc.png"  style="width:50px;vertical-align: middle;" alt="">
          </div>
	...
	<div class="weui-row weui-no-gutter weui_margin_fix" style="position:relative">
      <div class="weui-col-50" onclick="window.location.href='/balance/income.html'" style="border-right:1px solid #e8e8e8;"><p>50.25</p><span>今日收益(元)<span></div>
	...
	<div class="weui-grids weui_margin_fix">
		  ...
		  <a href="javascript:;" class="weui_grid js_grid">
			<div class="weui_grid_icon">
			  <img src="/public/images/signs.png" alt="">
			</div>
			<p class="weui_grid_label">
			  下线列表
			</p>
		  ...
		  <a href="javascript:;" class="weui_grid js_grid">
			<div class="weui_grid_icon">
			  <img src="/public/images/recharges.png" alt="">
			</div>
			<p class="weui_grid_label">
			  下线列表
			</p>
